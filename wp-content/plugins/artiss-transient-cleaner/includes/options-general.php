...
<h2><?php _e( 'Transient Cleaner Options', 'artiss-transient-cleaner' ); ?></h2>
...
<td><input type="checkbox" name="clean_enable" value="1"<?php if ( $options[ 'clean_enable' ] ) { echo ' checked="checked"'; } ?>/></td>
</tr>

<tr>
<th scope="row"><?php _e( 'Optimize afterwards', 'artiss-transient-cleaner' ); ?></th>
<td><input type="checkbox" name="clean_optimize" value="1"<?php if ( $options[ 'clean_optimize' ] ) { echo ' checked="checked"'; } ?>/>&nbsp;<span class="description"><?php _e( 'Not recommended', 'artiss-transient-cleaner' ); ?></span></td>
</tr>
...
<tr>
<th scope="row"><?php _e( 'Enable', 'artiss-transient-cleaner' ); ?></th>
<td><input type="checkbox" name="upgrade_enable" value="1"<?php if ( $options[ 'upgrade_enable' ] ) { echo ' checked="checked"'; } ?>/></td>
</tr>

<tr>
<th scope="row"><?php _e( 'Optimize afterwards', 'artiss-transient-cleaner' ); ?></th>
<td><input type="checkbox" name="upgrade_optimize" value="1"<?php if ( $options[ 'upgrade_optimize' ] ) { echo ' checked="checked"'; } ?>/></td>
</tr>
