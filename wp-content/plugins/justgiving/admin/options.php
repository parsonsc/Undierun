...
<div id="framework_wrap" class="wrap">
    ...
    <div id="content_wrap">
		...
		<option value="https://api.justgiving.com/" <?php if ($wppb_generalSettings['ApiLocation'] == 'https://api.justgiving.com/') echo 'selected="selected"';?>><?php _e('Live', 'justgiving');?></option>
            ...
            <div class="form-item">
            <label for="mguser"><?php _e('mailgun User ID:', 'justgiving');?></label>
            <input type="text" value="<?php echo $wppb_generalSettings['mguser']; ?>" id="mguser" name="jg_general_settings[mguser]" class="jg_general_settings"   />
            </div> 
            <div class="form-item">
            <label for="mgpass"><?php _e('mailgun password:', 'justgiving');?></label>
            <input type="text" value="<?php echo $wppb_generalSettings['mgpass']; ?>" id="mgpass" name="jg_general_settings[mgpass]" class="jg_general_settings"   />
            </div>            
            <div align="right">
